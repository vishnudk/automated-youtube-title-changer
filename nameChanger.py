...
def function():
    ...
    driver = webdriver.Chrome( 'D:\downloads\chromedriver',chrome_options= options)
    # while True:
    #     try:
    ...
    #         mailId.send_keys('your email id',Keys.ENTER)
    #         break
    #     except:
    #         pass
    ...
    while True:
        ...
        while True:
            try:
                driver.get("link to youtube studio editor page of the vedio")
                break
            except:
                pass
        while True:
